    ...
    <body class="font-inter flex flex-col h-screen overflow-hidden">
        ...
        <div class="flex flex-1 overflow-hidden">
            ...
            <aside id="sidebar" class="bg-sidebar-bg w-64 p-6 flex-col shadow-lg h-full overflow-y-auto transform -translate-x-full fixed inset-y-0 left-0 z-30 transition-transform duration-300 ease-in-out lg:relative lg:translate-x-0 lg:flex">
                <nav class="space-y-4 mt-8 lg:mt-0">
                    <!-- Added margin-top for mobile to account for fixed header -->
                    <!-- Dashboard Link -->
                    ...
                    <a href="#" data-section="student_payment_invoices" class="sidebar-link flex items-center space-x-3 p-3 rounded-lg text-sidebar-text-light hover:bg-sidebar-hover transition duration-200">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6M9 8h6m-8 12h10a2 2 0 002-2V6a2 2 0 00-2-2H9l-2 2H6a2 2 0 00-2 2v10a2 2 0 002 2z" />
                        </svg>
                    ...
                    <a href="#" data-section="exams" class="sidebar-link flex items-center space-x-3 p-3 rounded-lg text-sidebar-text-light hover:bg-sidebar-hover transition duration-200">
                        <svg class="h-6 w-6" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6M9 8h6m-3-6a1 1 0 00-1 1H9a2 2 0 00-2 2v14a2 2 0 002 2h6a2 2 0 002-2V5a2 2 0 00-2-2h-1a1 1 0 00-1-1z" />
                        </svg>
                        <span>Exams</span>
                    </a>
            ...
            <main class="flex-1 p-4 sm:p-8 overflow-y-auto">
                <div id="content-area" class="bg-card-bg p-6 sm:p-8 rounded-2xl shadow-xl w-full border border-border-light transform transition-all duration-300 hover:shadow-card-glow animate-fade-in">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div id="attendanceCard" class="bg-purple-50 border border-purple-300 rounded-xl p-6 mb-8 shadow-lg flex flex-col items-center justify-center text-center">
                            ...
                            <button id="markAttendanceBtn" class="bg-purple-600 text-white px-4 py-2 sm:px-5 sm:py-2 rounded-lg font-semibold shadow hover:bg-purple-700 transition text-sm sm:text-base">
                                Mark Attendance
                            </button>
                        ...
                        <div class="p-6 bg-gray-50 rounded-lg shadow-sm flex items-center justify-start space-x-3 text-text-secondary border border-border-light">
                            <svg class="h-6 w-6 sm:h-8 sm:w-8" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
