...
<div class="w-full md:w-1/2 p-10 left-bubble-bg text-white relative flex flex-col justify-center">
  ...
  <div class="relative">
    <input type="password" id="password" name="password" required
           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-pink-500 focus:border-pink-500 pr-10"
           placeholder="Enter your password">
    <i id="togglePassword" class="fa-solid fa-eye absolute right-3 top-3.5 text-gray-500 cursor-pointer"></i>
  </div>
</div>
